<template>
    <jet-action-section>
        ...
        <template #description>
            Administra y cierra sesión de tus otras sesiones activas en otros navegadores y dispositivos.
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                De ser necesario, puedes cerrar sesión de otros navegadores en todos tus dispositivos. Se listan algunas de tus sesiones más recientes; sin embargo, esta lista puede no ser exhaustiva. Si crees que tu cuenta ha sido comprometida, también deberías cambiar tu contraseña.
            </div>
                    ...
                    <div class="ml-3">
                        ...
                        <div>
                            <div class="text-xs text-gray-500">
                                ...
                                <span v-else>Activa por última vez {{ session.last_active }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Por favor, ingresa tu contraseña para confirmar que deseas cerrar tus otras sesiones.
